...
Future<BitmapDescriptor> getStartCustomMarker( int minutes, String destination ) async {
  ...
  final startMarkerPainter = StartMarkerPainter( minutes: minutes, destination: destination );
...
Future<BitmapDescriptor> getEndCustomMarker( int kilometers, String destination ) async {
  ...
  final startMarkerPainter = EndMarkerPainter( kilometers: kilometers, destination: destination );
  startMarkerPainter.paint( canvas, size );
